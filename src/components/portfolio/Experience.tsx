...
const items = [
  {
    ...
    org: "Vulture Lines · Chennai (Remote)",
    link: "/certificates/Anojan Internship Completion Certificate.pdf",
    points: [
      "Built backend features in Python Django for an internship management system.",
      "Shipped API development, DB operations and frontend integration on ESS, a client product.",
      "Hands-on experience across Django, REST APIs, MySQL and React.",
    ],
  },
];
              ...
              return (
                ...
                >
                  ...
                  <div
                    onClick={() =>
                      it.link &&
                      setSelectedPdf(it.link)
                    }
                    className={`glass rounded-2xl p-5 md:p-6 transition-all block ${
                      it.link
        ...
        {selectedPdf && (
          ...
          >
            <motion.div
              ...
              className="relative w-[95vw] md:w-[80vw] h-[90vh] rounded-3xl overflow-hidden glass border border-white/10 bg-black"
            >
              {/* CLOSE BUTTON */}
              <button
                onClick={() =>
